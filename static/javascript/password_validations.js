...
change_input_value(password, /^^/, min_length=8, is_Passwords=true)
change_input_value(password, /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*?&]{8,}$/, 8, true);
change_input_value(rePassword, /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*?&]{8,}$/, 8, true);
